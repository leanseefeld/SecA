...
public class DashboardHorarioListAdapter extends ArrayAdapter<Map<String, String>> {

    private final List<Map<String, String>> horarios;
    private final LayoutInflater inflater;

    public DashboardHorarioListAdapter(Context context, List<Map<String, String>> horarios) {
	...
	View row = inflater.inflate(R.layout.fragment_dashboard_horario_item, parent, false);
	...
	txtHorario.setText(horario.get("horarioInicio") + " - " + horario.get("horarioFim"));
