...
public class DisciplinasFragment extends MyFragment {
	...
	listDisciplinas = (ListView) v.findViewById(R.id.disciplinas_lista);
	...
	SimpleAdapter adapter = new SimpleAdapter(c, listarDisciplinas(), android.R.layout.simple_list_item_2, from, to);
